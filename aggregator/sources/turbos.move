module rockee_aggregator::turbos {
    ...
    public fun swap_a2b<CoinA, CoinB, Fee>(
        ...
        let (remainer_b, fee) = setting::pay_fee<CoinB>(bird_config, received_b, ctx);
    ...
    public fun swap_b2a<CoinA, CoinB, Fee>(
        ...
        let (remainer_a, fee) = setting::pay_fee<CoinA>(bird_config, received_a, ctx);
