module rockee_aggregator::cetus {
    ...
    const DEFAULT_PARTNER_ID: address = @0x639b5e433da31739e800cd085f356e64cae222966d0f1b11bd9dc76b322ff58b;
    ...
    public fun swap_a2b<CoinA, CoinB>(
        ...
        let (remainer_b, _fee) = setting::pay_fee<CoinB>(bird_config, receive_b, ctx);
    ...
    public fun swap_b2a<CoinA, CoinB>(
        ...
        let remainer_b = repay_flash_swap_b2a<CoinA, CoinB>(config, pool, partner, coin_b, flash_receipt, ctx);
        transfer_or_destroy_coin(remainer_b, ctx);

        let (remainer_a, _fee_amont) = setting::pay_fee<CoinA>(bird_config, receive_a, ctx);
    ...
    fun flash_swap<CoinA, CoinB>(
        ...
        let (receive_a, receive_b, flash_receipt) = if (object::id_address(partner) == DEFAULT_PARTNER_ID) {
